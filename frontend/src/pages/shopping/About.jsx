      ...
      <div className="min-h-screen bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-6">
         <div className="max-w-5xl w-full bg-white shadow-lg rounded-xl p-8 space-y-8 ring-2 ring-primary-300">
            ...
            <p className="text-lg text-gray-700 text-center">
               Welcome to <span className="font-semibold">Shine, Spark & Scroll</span>, your one-stop destination for premium products.
            ...
            <div className="text-center">
               <Link
                  to="/user/listing"
                  className="bg-primary-500 text-black px-6 py-3 rounded-lg font-medium text-lg hover:bg-primary-600 transition duration-300"
               >
                  Start Shopping
               </Link>
            </div>
